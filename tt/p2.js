javascript: (function() {
    ...
    const UtilsModule = (() => {
        ...
        const findStoredToken = () => {
            const tokenKeys = ['SSO-TOKEN', 'euisToken', 'EAP-TOKEN'];
            ...
            for (let i = 0; i < cookies.length; i++) {
                ...
                if (cookie.includes('SSO-TOKEN') || cookie.includes('euisToken') || cookie.includes('eap_token')) {
        ...
        const setupResultsDialogListeners = (modal) => {
            ...
            if (backToQueryBtn) {
                backToQueryBtn.addEventListener('click', () => {
                    ...
                    modal.querySelector('#pct-run-query').style.display = 'inline-flex';
                    backToQueryBtn.style.display = 'none';
                });
                backToQueryBtn.style.display = 'none'; // 初始狀態隱藏
            }
        };
