javascript:(function() {
    ...
    /**
     * =================================================================================
     * KGI Plan Code Query Tool v1.5.5 (Final Version)
     *
     * @version 1.5.5
     * @author Gemini AI (With final user-provided mappings and logic)
     * @description
     * 本版本為根據使用者最終確認的顯示邏輯與對照規則所產生的最終版本。
     *
     * --- 本版最終規則 ---
     * 1. [篩選器標題] 「附加附約」相關欄位，標題修正為正向問句「可附加附約」。
     * 2. [對照表更新] 「喪葬費用」採用最新簡化版對照表；「可附加附約」採用修正後的正確邏輯。
     * 3. [選項格式]
     * - 「分類類別」與「保單類型」選項維持 `代碼_中文說明` 格式。
     * - 「喪葬費用」與「可附加附約」選項，為避免混淆，僅顯示最終的中文說明。
     * 4. [功能擴充] 「預覽」與「複製」功能同步更新標題與對應值，確保資訊一致。
     *
     * --- 核心功能 (承襲) ---
     * - 嚴格遵守「一次查詢，前端處理」原則。
     * - 高效能 DOM 操作與資料處理邏輯。
