javascript: void((() => {
     ...
     * 3. [核心] 預設開啟頁籤改為「個人案件」。
     * 4. [UI/UX] 查詢/操作後自動收折篩選條件，最大化清單視野。
    ...
    const AppConfig = (() => {
        const staticConfig = {
            VERSION: '0813',
            TOOL_CONTAINER_ID: 'dispatch-tool-container-v21',
            STYLE_ELEMENT_ID: 'dispatch-tool-style-v21',
            TOKEN_KEY: 'euisToken',
            BATCH_PAGE_SIZE: 50,
    ...
    const createOptimizedState = () => {
        const state = {
            ...
            isLoading: false,
            activeTabId: 'personal' // [修正] 預設開啟個人案件
        };
        ...
        function injectStyle() {
            ...
            const style = domHelper.create('style', {
                ...
                textContent: `
                    ...
                    .filter-controls.collapsed { max-height: 0; padding: 0 16px; margin-bottom: 0; overflow: hidden; border-width: 0; }
    ...
    const createAppRunner = (appConfig, appState, apiService, uiComponents, utils, uiManager, domHelper) => {
        ...
        async function handleMainView(opts = {}) {
            ...
            appState.set('isLoading', false); // Ensure loading is always false after modal closes
