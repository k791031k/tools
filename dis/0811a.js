javascript: void((() => {
    /**
     * =================================================================================
     * 案件清單作業 - v0825.stable-merged (穩定融合版)
     * =================================================================================
     * @version      0825.stable-merged
     * @description
     * 1. [核心] 以 v0816 穩定版為基礎進行重構，確保所有核心功能與事件迴圈正常運作。
     * 2. [UI/UX] 整合 v0818 的橫向圖示工具列，取代舊版齒輪選單，提升操作直觀性。
     * 3. [修正] 修復篩選條件區塊的收折狀態在切換頁籤後無法記憶的問題，現在會保留使用者的操作狀態。
     * 4. [繼承] 保留 v0816 所有優點：獨立滾動、查詢條件顯示、欄位計數、API 快取等。
     * =================================================================================
     */
    'use strict';
